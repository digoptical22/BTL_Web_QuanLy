    ...
    <main>
        <div class="container">
            <div class="row">
                <div class="col-3"></div>
                <div class="col-6">
                    <form action="NewMajors.php" method="post">
                        <h1>Thêm Ngành Học</h1>
                        <hr>
                        <div class="container-fluid">
                            <div class="form-group mb-3">
                                <input name="idMajor" type="text" class="form-control" id="" aria-describedby="emailHelp" placeholder="Mã Ngành">
                            </div>
                            <div class="form-group mb-3">
                                <input name="nameMajor" type="text" class="form-control" id="" aria-describedby="emailHelp" placeholder="Tên Ngành">
                            </div>
                        </div>
                        <hr>
                        <button type="submit" class="btn btn-success btnInsert-1" name="newMajors">Thêm</button>
                    </form>
                </div>
                <div class="col-3"></div>
            </div>
